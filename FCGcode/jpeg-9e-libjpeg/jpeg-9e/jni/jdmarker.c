...
#define MAKE_BYTE_AVAIL(cinfo,action)  \
	if (bytes_in_buffer == 0) {  \
	  if (! (*datasrc->fill_input_buffer) (cinfo,0))  \
	    { action; }  \
	  INPUT_RELOAD(cinfo);  \
	}

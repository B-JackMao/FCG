...
class Subgraph {
 public:
  ...
  void SetExternalContext1(TfLiteExternalContextType type,
 ...
 private:
  ...
  TfLiteExternalContext* GetExternalContext1(TfLiteExternalContextType type);
  static TfLiteExternalContext* GetExternalContext1(
      struct TfLiteContext* context, TfLiteExternalContextType type);
  // Set the value of an external context.
  ...
  static void SetExternalContext1(struct TfLiteContext* context,
                                 TfLiteExternalContextType type,
                                 TfLiteExternalContext* ctx,TfLiteExternalContext* ctx2);
  ...
  TfLiteContext cpu1_context_ = {};
  TfLiteContext cpu2_context_ = {};
  TfLiteContext cpu3_context_ = {};
...
TfLiteExternalContext** external_contexts_cpu1_;
  ...
  bool enable_cpu_,enable_cpu1_, enable_gpu_, enable_dsp_;
  ...
  ctpl::thread_pool cpu1_thread_;

  ctpl::thread_pool cpu2_thread_;

...
class CLCommandQueue {
 public:
  ...
  absl::Status EnqueueMapBuffer(cl_mem memory,size_t size_in_bytes, const void* data);
  absl::Status EnqueueUnMapBuffer(cl_mem memory,size_t size_in_bytes, void* data);

...
std::cout<<"op-------761"<<std::endl;
  ...
  switch (effective_kernel_type) {
    case kReference: {//std::cout<<"recon-------"<<std::endl;
      reference_ops::Conv(
    ...
    case kGenericOptimized:
    case kMultithreadOptimized:
    case kCblasOptimized: {std::cout<<"op-------714"<<std::endl;
...
void EvalQuantizedPerChannel(TfLiteContext* context, TfLiteNode* node,
  ...
  switch (effective_kernel_type) {
    case kReference: {std::cout<<"conv re-------"<<std::endl;
    ...
    case kGenericOptimized:
    case kMultithreadOptimized:
    case kCblasOptimized: {//std::cout<<"op-------773"<<std::endl;
...
//std::cout<<"op-------873"<<std::endl;
  ...
  switch (effective_kernel_type) {
    ...
    case kCblasOptimized:
    case kGenericOptimized: {//std::cout<<"op-------918"<<std::endl;
...
std::cout<<"op-------1075"<<std::endl;
  ...
  switch (kernel_type) {
    ...
    case kCblasOptimized: {
      ...
      op_params.float_activation_min = output_activation_min;
      op_params.float_activation_max = output_activation_max;
      if (data->groups == 1) {std::cout<<"op-------1121"<<std::endl;
...
TfLiteStatus EvalImpl(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (input_type) {  // Already know in/outtypes are same.
    case kTfLiteFloat32://std::cout<<"conv float32-------"<<std::endl;
      ...
      break;
    case kTfLiteUInt8://std::cout<<"conv uint8-------"<<std::endl;
      EvalQuantized<kernel_type>(context, node, params, data, input, filter,
                                 bias, im2col, output);
      break;
    case kTfLiteInt8://std::cout<<"conv int8-------"<<std::endl;
      EvalQuantizedPerChannel<kernel_type>(context, node, params, data, input,
                                           filter, bias, output, im2col);
      break;
    case kTfLiteInt16://std::cout<<"conv int16-------"<<std::endl;

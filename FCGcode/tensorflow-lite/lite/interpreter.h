...
class Interpreter {
 ...
 private:
  ...
  TfLiteExternalContext* external_contexts_cpu1_[kTfLiteMaxExternalContexts];
...
std::unique_ptr<ExternalCpuBackendContext> own_external_cpu_backend_context_cpu1_;
